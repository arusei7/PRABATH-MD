...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRABATH-MD_UWCuyL1w",
BOT_NUMBER: process.env.BOT_NUMBER || "254115530969",
PASSWORD: process.env.PASSWORD || "atypical@1",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "arusei7",
GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN || "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"
};
